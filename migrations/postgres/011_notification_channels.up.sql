...
CREATE TABLE notification_channels (
    ...
    kind        TEXT NOT NULL CHECK (kind IN ('webhook', 'slack', 'telegram', 'telegram_app', 'whatsapp', 'whatsapp_app', 'discord', 'msteams', 'google_chat', 'email', 'pagerduty', 'ntfy', 'pushover', 'sms')),
