...
| `uptimepage_notifications_failures_total{transport}` | counter | notification sends that returned an error, by transport. Counts every failed attempt, including ones a later retry recovers |
